...
Board.prototype.registerEvents = function () {
    ...
    this.canvas.onclick = function (e) {
        ...
        var pos = _this.getNodePosFromCoord(x, y);
        _this.nodes[pos].resource = resources[0];
        _this.nodes[pos].draw(_this.ctx, true);
    };
};

Board.prototype.getNodePosFromCoord = function (x, y) {
    var px = parseInt(this.width / this.gridSize * (x * 100 / this.width * 0.01)) + 1,
...
Board.prototype.drawGrid = function () {
    ...
    for (var j = 0; j < this.height / this.gridSize; j++) {
        for (var i = 0; i < this.width / this.gridSize; i++) {
            var node = new _Node2.default(this.gridSize * i, this.gridSize * j, this.gridSize, this.gridSize);
